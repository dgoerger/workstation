...
execute 'enable_rpmfusion-free' do
  ...
  command 'dnf install -y https://download1.rpmfusion.org/free/fedora/rpmfusion-free-release-27.noarch.rpm'
  action :run
...
execute 'enable_rpmfusion-nonfree' do
  ...
  command 'dnf install -y https://download1.rpmfusion.org/nonfree/fedora/rpmfusion-nonfree-release-27.noarch.rpm'
  action :run
